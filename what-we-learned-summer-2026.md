---
title: "What Summer 2026 Told Us About the Car Market"
description: "Nine months of growth, a plug-in hybrid surge, a used market that turned, and an electric share hovering around a quarter. The summer's data, read as one story."
date: "2026-09-07"
...
Between January and August, 1,388,735 new cars were registered, [up 9.8% on the same period last year](https://www.smmt.co.uk/evs-lift-august-new-car-market-but-september-is-key-test/), with August itself rising 13.7% to mark the ninth consecutive month of growth and the best August since the biannual plate system was introduced. This is no longer a recovery story told in caveats. Private demand in particular ran ahead of the market at 12.5% growth year to date, which matters because private buyers, unlike fleets, respond to price and confidence rather than salary-sacrifice arithmetic.

## The powertrain mix is shifting in a direction few predicted

The summer's most interesting number is not the electric share but the plug-in hybrid surge. PHEV registrations rose 39.8% in August to a 14.5% share, after 33.6% growth in July, making the plug-in hybrid the fastest-growing powertrain in the country for two consecutive months, as we examined in [our hybrid market piece](/hybrid-sales-2026/). Conventional hybrids are growing steadily alongside them. The electric share meanwhile reached [29.8% in August](https://www.smmt.co.uk/evs-lift-august-new-car-market-but-september-is-key-test/), the second highest monthly figure of the year, though August's low volumes amplify percentages and the same seasonal spike has appeared every year since 2023.
...
For three years the used EV market was the industry's open wound. It closed this summer. The second quarter set a [record 110,761 used electric sales, up 67% year on year](/used-ev-market-q2/), prices rose for the first time since 2022, and by mid-summer used electric cars were [undercutting their petrol equivalents by £1,800 on average](/used-ev-price-gap/). A functioning used market is the quiet precondition for everything else in the transition, because it sets the residual values that determine monthly finance rates on new cars and gives first-time buyers a low-risk entry. That precondition now exists.

## The infrastructure story got less dramatic and more useful

Charging news stopped being about scarcity this summer. The public network passed [121,000 chargers, up 10% in a year](/uk-charging-network-state/), with the fastest growth in exactly the tier most owners use day to day. Prices at the plug were [noticeably stable through the season](/public-charging-price-tracker/). Nothing about the network is finished, and the rural gaps are real, but the summer's data describes a system that works for most electric drivers most of the time, which is a sentence that would not have survived fact-checking two summers ago.
...
- [SMMT: Huge EV boost in July yet mandate gap persists](https://www.smmt.co.uk/huge-ev-boost-in-july-yet-mandate-gap-persists/)
