---
title: "Hybrids Are the Quiet Winners of 2026"
description: "While electric cars grab the headlines, plug-in hybrids are growing faster than any other powertrain in Britain. Here is what the numbers say, and when a hybrid makes sense."
date: "2026-08-30"
...
The SMMT's own chief executive, Mike Hawes, put a health warning on the electric part of that growth, warning that the sector is "haemorrhaging billions in EV discounts" and calling for reform of the mandate regulation. The plug-in hybrid boom, by contrast, is happening with far less subsidy. The [Electric Car Grant](https://www.gov.uk/government/news/four-more-ev-models-qualify-for-3750-discount-under-electric-car-grant-as-government-pumps-an-extra-15-billion-into-the-switch-to-electric) applies only to fully electric models, so the £1,500 and £3,750 discounts pulling buyers towards BEVs do not apply here at all.

## The PHEV problem the numbers hide

A plug-in hybrid is only as clean and as cheap as its charging cable is long, or rather as often as it is actually plugged in. The published fuel economy figures assume a full battery at the start of every trip, which is why a family SUV can claim 280 mpg on paper. Real-world telemetry tells a blunter story. One UK fleet analysis of a Volkswagen Tiguan PHEV, [measured over a month of real driving](https://orbisio.co.uk/blog/phev-vs-bev-company-car), returned 65 mpg against that 287 mpg WLTP figure, with the vehicle running predominantly on a depleted battery. A plug-in hybrid that never charges is a heavy petrol car carrying a battery it does not use.

That matters most for company car drivers, and the tax system is deliberately designed to care. For 2026/27, [company car tax bands](https://www.gov.uk/tax-company-cars) separate the powertrains decisively: a fully electric car sits at 4% of its list price, while most plug-in hybrids on the UK fleet market, with 40 to 70 miles of electric range, sit in bands three to five times higher. We looked at what those bands mean in pounds per year in [our company car tax guide](/bik-company-car-ev-tax/). The short version: the tax gap between a plugged-in PHEV and an EV is real, and it compounds every year of the lease.
...
Match the powertrain to the driveway, not the brochure. That advice has not changed since we asked [how far the market is from the mandate line](/the-ev-mandate-gap/), and July's numbers suggest a lot of households are answering it sensibly.
...
- [Orbis IO: PHEV vs BEV company car, real-world fleet telemetry](https://orbisio.co.uk/blog/phev-vs-bev-company-car)
- [GOV.UK: Company car tax guidance](https://www.gov.uk/company-car-tax)
