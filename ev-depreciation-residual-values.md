---
title: "EV Depreciation: Are Electric Cars Finally Holding Their Value?"
description: "Used EV prices recorded their first annual rise since 2022 in June, and depreciation is slowing. We look at what the residual value data says for buyers and sellers."
date: "2026-08-09"
...
The clearest marker comes from Auto Trader's Retail Price Index for June 2026. The average advertised price of a used electric vehicle reached £24,662, up 1.6% year on year on a like-for-like basis, [the first annual increase in used EV prices since December 2022](https://plc.autotrader.co.uk/news-views/press-releases/used-ev-prices-return-to-growth-for-the-first-time-since-2022-as-wider-used-car-market-strengthens/). May had already ended forty consecutive months of annual price reductions with a flat reading, so June moved the market from stasis into growth.

The detail behind that headline matters just as much. It was not the newest, most expensive electric cars doing the work. It was the three to five-year-olds: prices in that bracket [rose 8.9% year on year to £19,295](https://plc.autotrader.co.uk/news-views/press-releases/used-ev-prices-return-to-growth-for-the-first-time-since-2022-as-wider-used-car-market-strengthens/), and stock left forecourts in an average of just 21 days, one of the fastest-selling segments of the entire used market. Nearly half of the used EV enquiries Auto Trader recorded in May were aimed at cars of that age. Buyers have worked out where the value sits.

Speed of sale tells its own story. Used EVs overall were selling [five days faster than the wider used market in June, at 25 days against 30](https://www.totallossgap.co.uk/blog/post/used-ev-prices-rise-in-2026-is-depreciation-slowing/650). Slow-moving stock is the classic symptom of a market that does not want a product; the opposite is a sign of genuine demand meeting available supply.
...
- [Auto Trader: Used EV prices return to growth for the first time since 2022](https://plc.autotrader.co.uk/news-views/press-releases/used-ev-prices-return-to-growth-for-the-first-time-since-2022-as-wider-used-car-market-strengthens/)
- [Fleet News: EV residual values find their footing as petrol depreciation accelerates](https://www.fleetnews.co.uk/news/opinion-ev-residual-values-find-their-footing-as-petrol-depreciation-accelerates)
- [Total Loss Gap: Used EV Prices Rise in 2026, Is Depreciation Slowing?](https://www.totallossgap.co.uk/blog/post/used-ev-prices-rise-in-2026-is-depreciation-slowing/650)
