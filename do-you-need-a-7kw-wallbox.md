---
title: "Do You Actually Need a 7kW Wallbox? The Honest Answer for UK EV Drivers"
description: "The average UK car covers about 20 miles a day, and a 3-pin plug can replace that overnight. So do you really need a 7kW home charger? The honest maths."
date: "2026-08-15"
...
The Department for Transport's National Travel Survey data, as compiled by the RAC Foundation, puts the [average annual mileage per car in England at about 7,100 miles](https://www.racfoundation.org/motoring-faqs/mobility) in 2024. That is roughly 19 miles a day. Battery electric cars actually cover more than the average, at an estimated 8,900 miles a year, and newer BEVs under three years old average [10,054 miles a year](https://www.racfoundation.org/motoring-faqs/mobility), around 27 miles a day. Even that heavier usage is a fraction of what a modern EV battery holds.
...
There is a real population for whom the answer is "not yet". If you drive under 15 miles most days, rarely make long trips, and are happy to top up on public chargers for the exceptions, the 3-pin cable that came with the car will do. Renters facing a move, and anyone about to change cars, might reasonably defer the decision. And the 65% of Great Britain households with off-street parking, [68% in England outside London but only 44% in the capital](https://www.racfoundation.org/motoring-faqs/mobility), includes plenty of people whose parking arrangement does not suit a fixed charger at all.

For those groups, the public network has matured enough to be a genuine plan A rather than a compromise, something we charted in [our review of the UK charging network](/uk-charging-network-state/). The cost per mile is higher than home charging, but for low annual mileage the total difference is small in absolute terms.

## The grant situation, briefly

Since 1 April 2026, the OZEV chargepoint grant for the home is worth [up to £500 per socket, up from £350](https://www.gov.uk/guidance/changes-to-electric-vehicle-chargepoint-grant-schemes-from-1-april-2026), and it is aimed at renters, flat owners and landlords. Homeowners with a driveway have not been eligible since 2022, so most buyers pay the full installed price, typically £800 to £1,200 for a straightforward 7kW fit. If you do qualify for the grant, the case for installing gets stronger. We break down the full costs in [our wallbox cost guide](/how-much-does-a-wallbox-cost/).
...
- [RAC Foundation: General facts and figures about roads and road use](https://www.racfoundation.org/motoring-faqs/mobility)
