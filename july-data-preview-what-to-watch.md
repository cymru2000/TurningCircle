---
title: "July Data: What to Watch When the SMMT Numbers Land"
description: "The SMMT publishes July registration figures this morning. Early independent numbers point to another strong EV month. Here is how to read the release like an analyst, not a headline."
date: "2026-08-05"
...
Its figures show [43,547 new BEVs registered in July, a 27.4% share of the market](https://transportandenergy.com/2026/08/04/ev-sales-outpace-zev-mandate-trajectory-again-as-groups-warn-against-policy-changes/), with registrations up almost 50% on July 2025 and BEVs the fastest-growing segment of an expanding market. If the SMMT's final numbers land anywhere near that, July would be the second consecutive month in which electric sales outpaced the ZEV mandate's underlying trajectory.

That last phrase needs unpacking, since it is the single most useful concept for reading today's release. The mandate's headline target is 33% for 2026, but the scheme's flexibilities, the credit trading, borrowing and CO2 conversion we explain in [how ZEV mandate credit trading works](/zev-mandate-credit-trading/), lower the effective bar. New AutoMotive puts the effective market-wide target at [24.6% once flexibilities are accounted for, against a year-to-date BEV share of 25.3%](https://transportandenergy.com/2026/08/04/ev-sales-outpace-zev-mandate-trajectory-again-as-groups-warn-against-policy-changes/). On that reading, the market is not behind the mandate at all; it is slightly ahead of the version of the mandate that manufacturers actually have to hit.
...
First, the BEV share against June's 30.0%. June was flattered by the quarter-end push, when manufacturers work hardest to move metal, so some fallback in July is expected and would not be alarming. The question is whether July lands in the high twenties, which would confirm that June was a step change rather than a spike, or drops back towards the mid-twenties, which would suggest the record month was mostly calendar effects. The half-year context matters here: [284,579 BEVs out of 1,137,929 registrations in the first six months](https://www.smmt.co.uk/ev-market-hits-new-high-but-target-gap-remains/), a 25.0% share, is the base the second half has to build on.
...
- [Transport and Energy: EV sales outpace ZEV Mandate trajectory again (New AutoMotive July data)](https://transportandenergy.com/2026/08/04/ev-sales-outpace-zev-mandate-trajectory-again-as-groups-warn-against-policy-changes/)
- [SMMT: EV market hits new high but target gap remains (June 2026 data)](https://www.smmt.co.uk/ev-market-hits-new-high-but-target-gap-remains/)
- [SMMT: Two millionth electric car registered (April 2026 data and outlook)](https://www.smmt.co.uk/two-millionth-electric-car-registered-as-market-rebounds-strongly-from-tax-changes/)
- [SMMT: Key press dates](https://www.smmt.co.uk/key-press-dates/)
