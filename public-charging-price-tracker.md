---
title: "Where Public Charging Prices Stand Going Into Autumn"
description: "Our regular check on what UK drivers actually pay per kWh on the public network: July's averages, the membership effect, and the arithmetic that decides whether charging beats petrol."
date: "2026-09-02"
...
Using [Zapmap's price index](https://www.zapmap.com/ev-stats/charging-price-index), built from close to four million charge sessions a month, the July averages are these: around 54p per kWh on standard and standard-plus chargers, the 3kW to 49kW tier that covers most destination and on-street charging, and around 79 to 80p per kWh on the rapid and ultra-rapid PAYG rates you pay at motorway-style sites without a membership or subscription. Zapmap's own [rapid price tables](https://www.zapmap.com/ev-stats/rapid-charging-prices) show the spread between networks remains wide, with PAYG rapid prices running from the high 50s to the high 80s depending on the operator.

Turn those kilowatt-hour prices into miles and the picture gets practical. At an efficient 4 miles per kWh, 54p standard charging works out near 13p per mile, rapid PAYG near 20p, against a typical petrol car at [roughly the same cost per mile once fuel duty is counted](/fuel-duty-vs-electric-mile/). The home-versus-public gap is where EV economics still win: charge overnight on an EV tariff at 7p to 8p per kWh and the same mile costs about 2p.
...
The first is network memberships. Most major operators sell a monthly subscription that shaves a fixed amount off each kWh, and for anyone rapid-charging more than two or three times a month the maths usually lands in the member's favour. The second is contactless and app rates, which several networks now price below their PAYG headline as competition for drivers intensifies. The third is location discipline: the same kilowatt-hour can cost 20p less a few minutes off the motorway, and the [state of the charging network](/uk-charging-network-state/) makes those detours increasingly viable, with more than 121,000 public charge points now live across the country and the fastest growth happening in the cheaper destination tier rather than at premium rapid sites.
...
If you charge at home, none of this changes your life: the [home charging route](/how-much-does-a-wallbox-cost/) remains roughly a quarter of the cost of the motorway rapid. If you depend on the public network, the July data says your costs are stable and your savings are in your own hands, a membership here, a destination charger there, and a habit of checking two apps before plugging in. Charging an EV is already [cheaper than fuelling a petrol car](/charging-prices-per-kwh/) for most drivers; keeping it that way on the road is mostly a planning exercise now rather than a price-watching one.

The Autumn Budget will tell us whether the government adds anything to the demand side, and October brings the closure of the mandate review, whose outcome [will shape discounting](/zev-mandate-review-halfway/) and therefore the effective price of going electric. Between now and then, the tracker's message is simple: prices are flat, the cheap end of the network is growing fastest, and the driver with a plan pays a fraction of the driver without one.

## Sources

- [Zapmap: UK EV Charging Price Index](https://www.zapmap.com/ev-stats/charging-price-index)
- [Zapmap: UK Rapid EV Charging Prices, Top 10 Networks](https://www.zapmap.com/ev-stats/rapid-charging-prices)
